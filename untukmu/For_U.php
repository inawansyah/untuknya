...
=========================*/
    ...
    konten = [{
      ...
      {
        gambar: "gambar2.gif",
        ucapan: "Semangat Terus ya❤",
      },
      {
        gambar: "gambar3.gif",
        ucapan: "Aku mau izin mengajak kamu jalan berdua boleh? Kalau mau balas pesanku ya",
      },
    ];

    musik = "Bryant Barnes - Want You All The Time (320).mp3";
    nomorWhatsapp = "6281802251669";
